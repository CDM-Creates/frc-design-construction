...
export const DOCUMENT_CATEGORIES: DocumentCategoryDefinition[] = [
  ...
  },
  {
    ...
    label: "Statutory planning or property certificate",
    description: "The current council or authority-issued property/planning certificate and attachments, such as a NSW Section 10.7 certificate or the relevant state equivalent.",
    multiple: true,
    acceptedFormats: "PDF, JPG, JPEG, PNG or TIFF",
  },
  {
    code: "basix_certificate",
    label: "Energy and sustainability assessment",
    description: "The current jurisdiction-specific assessment and commitments, such as BASIX in NSW or the applicable NatHERS, Whole-of-Home or state pathway.",
    multiple: true,
    acceptedFormats: "PDF, JPG, JPEG, PNG or TIFF",
  },
  {
